...
export interface ApiBogBog extends Schema.CollectionType {
  collectionName: 'bogs';
  info: {
    singularName: 'bog';
    pluralName: 'bogs';
  ...
  attributes: {
    ...
    url: Attribute.UID<'api::bog.bog', 'titulo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::bog.bog', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::bog.bog', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiNosotroNosotro extends Schema.SingleType {
